      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <Tab
              icon={<FaFileAlt style={{ fontSize: 20 }} />}
              iconPosition="start"
              ...
              <Box sx={{ px: 4, pb: 5 }}>
                ...
                >
                  <Box>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Services this dealer is currently providing.
                    </Typography>
                  </Box>
                  <Stack direction="row" spacing={2}>
                    <Button
                      ...
                      onClick={() =>
                        navigate(
                          `/create-additional-service?dealerId=${dealer._id}`,
                        )
                      }
                    ...
                    <Button
                      ...
                      startIcon={<AddCircleOutlineIcon />}
                      onClick={() =>
                        navigate(`/create-service?dealerId=${dealer._id}`)
                      }
                      sx={{ fontWeight: "800", borderRadius: 2, px: 3 }}
                    >
                      Set Major Service
                ...
                groupedAdditionalServices.length === 0 ? (
                  ...
                  >
                    <FaTools
                      size={48}
                      style={{ color: "#cbd5e1", marginBottom: 20 }}
                    />
                    <Typography
                      variant="h6"
                      fontWeight="700"
                    ...
                    <Typography
                      ...
                      sx={{ mb: 4 }}
                    >
                      This dealer is not providing any services yet. They won't
                                ...
                                <Box sx={{ flexGrow: 1 }}>
                                  ...
                                  >
                                    {group.instances.reduce(
                                      (acc, inst) =>
                                        acc + (inst.bikes?.length || 0),
                                      0,
                                    )}{" "}
                                    Configurations across{" "}
                                    {group.instances.length} assignment(s)
                                  </Typography>
                                </Box>
                                <Box sx={{ display: "flex", gap: 1, mr: 2 }}>
                                  {(() => {
                                    const allPrices = group.instances.flatMap(
                                      (i) => i.bikes || [],
                                    );
                                    const minP = Math.min(
                                      ...allPrices.map((b) => b.price),
                                    );
                                    const maxP = Math.max(
                                      ...allPrices.map((b) => b.price),
                                    );
                                    ...
                                    >
                                      ...
                                      >
                                        <Grid item xs={12} md={5}>
                                          ...
                                          <Chip
                                            label={`${instance.bikes?.length || 0} Models Assigned`}
                                            size="small"
                                            icon={<FaTools />}
                                            sx={{ fontWeight: 700 }}
                                          />
                              ...
                              >
                                ...
                                <Box sx={{ flexGrow: 1 }}>
                                  ...
                                  >
                                    ...
                                    CC Ranges across {group.instances.length}{" "}
                                    assignment(s)
                                  </Typography>
                                </Box>
                                <Box sx={{ display: "flex", gap: 1, mr: 2 }}>
                                    ...
                                    >
                                      ...
                                      >
                                        <Grid item xs={12} md={5}>
                                          ...
                                          <Chip
                                            label={`${instance.bikes?.length || 0} CC Ranges`}
                                            size="small"
                                            icon={<SettingsIcon />}
                                            sx={{ fontWeight: 700 }}
                                          />
                                        ...
                                        >
                                          <Button
                                            ...
                                            onClick={() =>
                                              navigate(
                                                `/additional-services/edit/${instance._id}`,
                                              )
                                            }
                                            sx={{
                                              fontWeight: 800,
